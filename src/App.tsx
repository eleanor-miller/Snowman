...
function App() {
  const [word] = useState(wordList[Math.floor(Math.random() * 1024)]) // TODO : Pick random word from list
  ...
  const snowmen = [
    ...
    <img src={'./src/snowman/step_7.png'} className="App-logo" />,
  ]
  const [matches, setMatches] = useState(0)
  const [snowman, setSnowman] = useState(snowmen[matches])
